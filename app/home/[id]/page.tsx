...
export default async function HomeRoute({
  ...
  return (
    <div className="w-[75%] mx-auto mt-10 mb-36">
      <h1 className="font-medium mb-5 text-2xl">{data?.title}</h1>
      <div className="relative h-[550px]">
        <Image
          alt="Image of home"
          src={`https://iyeumvdpnogttgcppjwk.supabase.co/storage/v1/object/public/images/${data?.photo}`}
          fill
          className="rounder-lg h-full object-cover w-full"
        />
      </div>
